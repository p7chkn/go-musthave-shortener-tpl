...
func (h *Handler) setupMock() {
	var respositoryInterface models.RepositoryInterface

	dataMap := new(models.RepositoryMap)
	dataMap.SetupValues()
	respositoryInterface = dataMap
	h.repo = respositoryInterface
}
