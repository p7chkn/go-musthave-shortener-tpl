...
func (_m *MockRepositoryInterface) GetStats(ctx context.Context) (StatResponse, error) {
	ret := _m.Called(ctx)

	var r0 StatResponse
	if rf, ok := ret.Get(0).(func(context.Context) StatResponse); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(StatResponse)
	}
